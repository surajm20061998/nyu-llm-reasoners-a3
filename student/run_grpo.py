...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--prompt-path",
        default=str(SCRIPT_DIR / "prompts" / "countdown.prompt"),
    )
    parser.add_argument(
...
def main() -> None:
    ...
    train_path = resolve_repo_path(args.countdown_train_path)
    dev_path = resolve_repo_path(args.countdown_dev_path)
    test_path = resolve_repo_path(args.countdown_test_path)
